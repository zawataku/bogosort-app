<template>
    <main
        class="flex flex-col items-center gap-3 justify-center min-h-screen md:min-h-[101vh] p-8 bg-gray-200"
    >
        <div
            class="flex flex-col gap-8 w-full max-w-2xl p-8 bg-white shadow-lg rounded-xl relative"
        >
            ...
            <div class="flex justify-center">
                <button
                    class="bg-blue-500 text-white text-lg font-bold py-3 px-8 rounded-lg text-center"
                    @click="startSorting"
                >
                    ボゴソート開始！
                </button>
        ...
        <div class="w-full max-w-2xl text-right px-8">
            <a
                class="text-lg font-bold text-gray-500 underline underline-offset-4 cursor-pointer"
        ...
        <dialog id="modal" class="modal">
            <div class="modal-box flex flex-col">
                <h3 class="font-bold text-center text-2xl py-4">
                    ボゴソートとは？
                </h3>
                <p class="py-4 leading-7">
                    ...
                    <br />
                    <br />
                    このアルゴリズムの平均計算時間は O(n×n!) 、最悪計算時間は
                    O(∞)
                    であり、数あるソートアルゴリズムの中でも最悪の性能とされています。
                    <br />
                    <br />
                    しかしその反面、最良計算時間は O(n)
                    というクイックソートを超える最速のソート時間を叩き出すことができるため、理論上は最速のソートアルゴリズムとも言われています...たぶん。
                    <br />
                </p>
            </div>
